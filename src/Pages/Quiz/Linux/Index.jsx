...
export default function Linux() {
    ...
    const category = 'Linux'; // Categoria do quiz (pode ser ajustada conforme necessário)
    ...
    const calculateAndSaveScore = async () => {
      ...
      { // Verifica se o usuário está autenticado
        ...
        {
          navigate('/linux_score'); // Redireciona para a página de resultados após concluir o quiz
        }
      } 
      else 
      {
