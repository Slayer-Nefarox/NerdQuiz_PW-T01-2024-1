...
export default function Mixed() {
    ...
    const category = 'Mixed'; // Categoria do quiz (pode ser ajustada conforme necessário)
    ...
    const calculateAndSaveScore = async () => {
      ...
      { // Verifica se o usuário está autenticado
        ...
        {
          navigate('/mixed_score'); // Redireciona para a página de resultados após concluir o quiz
        }
      } 
      else 
      {
