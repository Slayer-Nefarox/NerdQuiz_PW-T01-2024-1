...
export default function Networking() {
    ...
    const category = 'Networking'; // Categoria do quiz (pode ser ajustada conforme necessário)
    ...
    const calculateAndSaveScore = async () => {
      ...
      { // Verifica se o usuário está autenticado
        ...
        {
          navigate('/networking_score'); // Redireciona para a página de resultados após concluir o quiz
        }
      } 
      else 
      {
