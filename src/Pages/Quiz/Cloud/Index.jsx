...
export default function Cloud() {
    ...
    const category = 'cloud'; // Categoria do quiz (pode ser ajustada conforme necessário)
    ...
    const calculateAndSaveScore = async () => {
      ...
      { // Verifica se o usuário está autenticado
        ...
        {
          navigate('/cloud_score'); // Redireciona para a página de resultados após concluir o quiz
        }
      } 
      else 
      {
